...
# probably there is an error in 01_create_big_table.R
# so we search for suspicious observations
...
setwd('~/courseworks/2013/annette/airfares/rawdata/')
